...
#membuat database dengan nama "db_sales_V3922004"
cursorObject.execute("CREATE DATABASE db_sales_V3922004")
...
while True:
    print(" ")
    print("----SELAMAT DATANG DI APLIKASI DATABASE BARANG----")
    print("1. Insert data")
    print("2. Show data")
    print("3. Update data")
    print("4. Hapus data")
